...
def get_office_MVPs():
	...
	for agent in dAgent:
		if office == 'Atlanta':
			...
			break
		if office == 'Orlando':
			wc = "Category__c INCLUDES ('Market Mailer') and (Top100__c INCLUDES ('Mike Ripley', 'Kathleen Rutland') and Top100__c EXCLUDES ('David Moore')"
			...
			wc = "Category__c INCLUDES ('Market Mailer') and (Top100__c INCLUDES ('Ben Heglie') and Top100__c EXCLUDES ('Mike Schwab', 'Kirk McCarville', 'Trey Davis')"
			break
