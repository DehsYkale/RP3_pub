...
def load_person_enrichment_prompt(persons: list, address: str) -> str:
	...
	with open('F:/Research Department/Code/Prompts/Fox_Hunter_Person_Enrichment_AI_Prompt_v03.txt.txt', 'r', encoding='utf-8') as file:
		prompt = file.read()
...
def load_contacts_of_entity_prompt(companies_data):
	...
	with open('F:/Research Department/Code/Prompts/Fox_Hunter_Contacts_of_Entity_AI_Prompt_v03.txt', 'r', encoding='utf-8') as file:
		prompt = file.read()
